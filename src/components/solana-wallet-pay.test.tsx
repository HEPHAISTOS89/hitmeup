...
describe("Solana wallet checkout", () => {
  ...
  it("links the injected public address before enabling the payment", async () => {
    prepareWallet();
    const quote: CosmeticQuote = { network: "devnet", productId: "profile-frame", label: "Profile frame", lamports: 10_000_000, treasury: "11111111111111111111111111111111", checkoutId: "00000000-0000-4000-8000-000000000001" };
