...
function legacy(input: Omit<AvatarMarketplaceCatalogItem, "unlockMethod" | "purchaseSku" | "lamports" | "rewardPoints">, purchaseSku: "profile-frame" | "campus-theme" | "trust-badge"): AvatarMarketplaceCatalogItem {
  return { ...input, unlockMethod: "solana_devnet", purchaseSku, lamports: SOLANA_AVATAR_PRODUCTS[purchaseSku].lamports, rewardPoints: 0 };
}
...
/**
 * Canonical server-backed visual catalog for the HitMeUp avatar studio.
 * The avatar.* pack is deterministic original SVG artwork generated in this repository.
 */
export const AVATAR_MARKETPLACE_CATALOG: readonly AvatarMarketplaceCatalogItem[] = [
  ...
  premium({ sku: "avatar.accessory.beanie", label: "Night beanie", category: "accessory", value: "beanie", equipGroup: "accessory:headwear", collections: both, assetStatus: approved, sortOrder: 60 }),
  premium({ sku: "avatar.accessory.bag", label: "Crossbody bag", category: "accessory", value: "bag", equipGroup: "accessory:bag", collections: both, assetStatus: approved, sortOrder: 61 }),
  premium({ sku: "avatar.accessory.wallet", label: "Wallet chain", category: "accessory", value: "wallet", equipGroup: "accessory:wallet", collections: ["male"], assetStatus: approved, sortOrder: 62 }),
  premium({ sku: "avatar.accessory.stars", label: "Star earrings", category: "accessory", value: "stars", equipGroup: "accessory:earrings", collections: ["female"], assetStatus: approved, sortOrder: 63 }),
  ...
  reward({ sku: "reward-frame-mint", label: "Mint circuit frame", category: "frame", value: "mint", equipGroup: "frame", collections: both, assetStatus: approved, sortOrder: 82 }, 40),
  reward({ sku: "reward-frame-solar", label: "Solar circuit frame", category: "frame", value: "solar", equipGroup: "frame", collections: both, assetStatus: approved, sortOrder: 83 }, 60),
  reward({ sku: "reward-patch-nearby", label: "Nearby reward patch", category: "patch", value: "nearby", equipGroup: "patch", collections: both, assetStatus: approved, sortOrder: 84 }, 80),
  reward({ sku: "reward-motion-drift", label: "Drift reward motion", category: "motion", value: "drift", equipGroup: "motion", collections: both, assetStatus: approved, sortOrder: 85 }, 100),

  legacy({ sku: "profile-frame", label: "Profile frame", category: "frame", value: "constellation", equipGroup: "frame", collections: both, assetStatus: approved, sortOrder: 90 }, "profile-frame"),
  legacy({ sku: "campus-theme", label: "Campus theme", category: "motion", value: "pulse", equipGroup: "motion", collections: both, assetStatus: approved, sortOrder: 91 }, "campus-theme"),
  legacy({ sku: "trust-badge", label: "Trust badge", category: "patch", value: "relay", equipGroup: "patch", collections: both, assetStatus: approved, sortOrder: 92 }, "trust-badge"),
];
